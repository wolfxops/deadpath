...
FRAMEWORKS: dict[str, dict] = {
    ...
    # ---- JVM ---------------------------------------------------------------
    "spring": {"language": "java", "also": ["kotlin", "scala"], "imports": ["org.springframework"], "deps": ["spring-boot", "org.springframework"],
               "entry_files": ["Application.java", "Application.kt", "Application.scala"], "entry_dirs": ["controller", "controllers", "config", "configuration", "repository", "entity", "resources"],
    ...
    "quarkus": {"language": "java", "also": ["kotlin", "scala"], "imports": ["io.quarkus", "jakarta.ws.rs", "javax.ws.rs"], "deps": ["quarkus", "io.quarkus"],
                "entry_files": [], "entry_dirs": ["resources"], "decorators": ["Path", "ApplicationScoped", "Inject", "Produces"], "bases": []},
    "micronaut": {"language": "java", "also": ["kotlin", "scala"], "imports": ["io.micronaut"], "deps": ["micronaut", "io.micronaut"],
                  "entry_files": ["Application.java"], "entry_dirs": [], "decorators": ["Controller", "Singleton", "Factory"], "bases": []},
    "junit": {"language": "java", "also": ["kotlin", "scala"], "imports": ["org.junit", "org.testng"], "deps": ["junit", "org.junit", "testng"],
...
def _manifest_deps(root: Path, profile: Profile) -> set[str]:
    ...
    simple_manifests = {
        ...
        "Package.swift": r"""\.package\([^)]*?["'](?:https?://[^"']+/)?([\w.-]+?)(?:\.git)?["']|name:\s*["'](\w+)["']""",
